...
import { ViewProfileOutput } from "../ViewProfileOutput";
...
export class ProfileControllerBase {
  ...
  async UpdateProfile(
    @common.Body()
    body: ViewProfileOutput
  ): Promise<UpdateProfileInput> {
    return this.service.UpdateProfile(body);
  }

  @common.Get("/profile/view")
  @swagger.ApiOkResponse({
    type: ViewProfileOutput,
  })
  @swagger.ApiNotFoundResponse({
    type: errors.NotFoundException,
  })
  ...
  async ViewProfile(
    @common.Body()
    body: ViewProfileOutput
  ): Promise<ViewProfileOutput> {
    return this.service.ViewProfile(body);
  }
}
